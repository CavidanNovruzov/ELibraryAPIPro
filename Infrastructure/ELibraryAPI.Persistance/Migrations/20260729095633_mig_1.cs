        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Campaigns_DiscountPercent_Range", "[DiscountPercent] >= 0 AND [DiscountPercent] <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDelegatable = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PromoCodes_DateRange", "[StartDate] < [EndDate]");
                    table.CheckConstraint("CK_PromoCodes_DiscountPercent_Range", "[DiscountPercent] >= 0 AND [DiscountPercent] <= 100");
                    table.CheckConstraint("CK_PromoCodes_UsageLimit_NonNegative", "[UsageLimit] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BranchWorkHours", x => x.Id);
                    table.CheckConstraint("CK_BranchWorkHours_OpenBeforeClose", "[OpenTime] < [CloseTime]");
                    table.ForeignKey(
                        name: "FK_BranchWorkHours_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_DiscountPrice_Valid", "[DiscountPrice] IS NULL OR ([DiscountPrice] >= 0 AND [DiscountPrice] <= [SalePrice])");
                    table.CheckConstraint("CK_Products_PageCount_Positive", "[PageCount] > 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BasketItems_Quantity_Positive", "[Quantity] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PriceHistories_NewPrice_NonNegative", "[NewPrice] >= 0");
                    table.CheckConstraint("CK_PriceHistories_OldPrice_NonNegative", "[OldPrice] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchWorkHours_BranchId_Day",
                table: "BranchWorkHours",
                columns: new[] { "BranchId", "Day" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BranchWorkHours_IsDeleted",
                table: "BranchWorkHours",
                column: "IsDeleted",
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAuthors_IsDeleted",
                table: "ProductAuthors",
                column: "IsDeleted",
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCampaigns_IsDeleted",
                table: "ProductCampaigns",
                column: "IsDeleted",
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCampaigns_ProductId_CampaignId",
                table: "ProductCampaigns",
                columns: new[] { "ProductId", "CampaignId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGenres_IsDeleted",
                table: "ProductGenres",
                column: "IsDeleted",
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_ProductGenres_ProductId_GenreId",
                table: "ProductGenres",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSearchHistories_IsDeleted",
