...
public class PermissionReadRepository : ReadRepository<Permission,int>, IPermissionReadRepository
{
    public PermissionReadRepository(ELibraryDbContext context) : base(context)
    {
    }
}
